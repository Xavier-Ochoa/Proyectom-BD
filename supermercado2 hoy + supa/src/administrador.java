...
public class administrador {
    ...
    private JButton bitacoraButton;
    private JButton salirButton;
    private User usuarioLogeado;

    public administrador(User usuarioLogeado) {
        ...
        empleadosButton.addActionListener(e -> {
            JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(panel1);
            administrador_empleados pantallaEmpleados = new administrador_empleados(usuarioLogeado);
            frame.setContentPane(pantallaEmpleados.panel1);
            frame.revalidate();
            frame.repaint();
        });
        ...
        proveedoresButton.addActionListener(e -> {
            JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(panel1);
            administrador_proveedores pantallaProveedores = new administrador_proveedores(usuarioLogeado);
            frame.setContentPane(pantallaProveedores.panel1);
            frame.revalidate();
            frame.repaint();
        });

        bitacoraButton.addActionListener(e -> {
            JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(panel1);
            administrador_bitacora pantallaBitacora = new administrador_bitacora(usuarioLogeado);
            frame.setContentPane(pantallaBitacora.panel1);
            frame.revalidate();
            frame.repaint();
        });
